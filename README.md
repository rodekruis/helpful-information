...
- This folder can be deployed to any hosting-solution (supporting HTTPS), using [the recommended server configuration](https://v11.angular.io/guide/deployment#server-configuration).
